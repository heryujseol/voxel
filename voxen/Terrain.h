...
namespace Terrain {
	...
	/*
	 * x, y : ì¢Œí‘œ
	 * - ?„ì¬ x, yê°€ ì¤‘ìš”?œê²Œ ?„ë‹ˆ?? ?´ë‹¹ ?¨ìˆ˜ë¥??¸ì¶œ????x, y??ì¦ê° ??´ ì¤‘ìš”??ê²?
	 * - ì¦ê°???‘ì•„???? ?¬ë©´ ?ì§„?ì¸ ë³€?”ìœ¨??ì²´í¬?????†ìŒ
	 * freq : ì§„ë™?? ì£¼íŒŒ??
	 * - x, y??ë²”ìœ„ë¥??¬ì¡°?•í•˜ê²???
	 * - freqë§Œí¼ êµ¬ê°„???˜ê²Œ ?˜ëˆ„ê²???ê²?
	 * - ë°˜ë³µ ?Ÿìˆ˜ê°€ ?¬ë¼ê°€ë©?êµ¬ê°„???”ìš± ?˜ê²Œ ?˜ëˆ” (2ë°°ì”©)
	 * octave : ?¥í?ë¸?
	 * - ?¸ì´ì¦ˆì˜ ë°˜ë³µ ?Ÿìˆ˜
	 * - ?´ë‹¹ ë°˜ë³µ???°ë¼??freq, amp???í–¥??ë¯¸ì¹¨
	 * amp : ì§„í­
	 * - ?¸ì´ì¦??°ì‚°???€??ê²°ê³¼???í–¥?¥ì´?¼ê³  ?ê°?˜ë©´ ??
	 */
