...
namespace MeshGenerator {
	...
	static VoxelVertex SetVoxelVertex(
		int x, int y, int z, int face, BIOME_TYPE biome, TEXTURE_INDEX textureIndex)
	{
		VoxelVertex v{};
	...
	static void CreateQuadMesh(std::vector<VoxelVertex>& vertices, std::vector<uint32_t>& indices,
		int x, int y, int z, int merged, int length, int face, BIOME_TYPE biome, TEXTURE_INDEX textureIndex)
	{
		...
		if (face == 0) { // left
			vertices.push_back(
				SetVoxelVertex(x, y + length, z + merged, face, biome, textureIndex));		 // 0, 0
			vertices.push_back(SetVoxelVertex(x, y + length, z, face, biome, textureIndex)); // 1, 0
			vertices.push_back(SetVoxelVertex(x, y, z, face, biome, textureIndex));			 // 1, 1
			vertices.push_back(SetVoxelVertex(x, y, z + merged, face, biome, textureIndex)); // 0, 1
		}
		else if (face == 1) { // right
			vertices.push_back(SetVoxelVertex(x, y + length, z, face, biome, textureIndex));
			vertices.push_back(
				SetVoxelVertex(x, y + length, z + merged, face, biome, textureIndex));
			vertices.push_back(SetVoxelVertex(x, y, z + merged, face, biome, textureIndex));
			vertices.push_back(SetVoxelVertex(x, y, z, face, biome, textureIndex));
		}
		else if (face == 2) { // bottom
			vertices.push_back(SetVoxelVertex(x, y, z, face, biome, textureIndex));
			vertices.push_back(SetVoxelVertex(x + merged, y, z, face, biome, textureIndex));
			vertices.push_back(
				SetVoxelVertex(x + merged, y, z + length, face, biome, textureIndex));
			vertices.push_back(SetVoxelVertex(x, y, z + length, face, biome, textureIndex));
		}
		else if (face == 3) { // top
			vertices.push_back(SetVoxelVertex(x, y, z + length, face, biome, textureIndex));
			vertices.push_back(
			...
			vertices.push_back(SetVoxelVertex(x, y + length, z, face, biome, textureIndex));
			vertices.push_back(
				SetVoxelVertex(x + merged, y + length, z, face, biome, textureIndex));
			vertices.push_back(SetVoxelVertex(x + merged, y, z, face, biome, textureIndex));
			vertices.push_back(SetVoxelVertex(x, y, z, face, biome, textureIndex));
		}
		else if (face == 5) { // back
